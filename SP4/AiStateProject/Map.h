...
public:
	...
	enum TileList
	{
		...
		BROWNFLOOR, GRASS,
		BOOKSHELF00, BOOKSHELF01, BOOKSHELF02, BOOKSHELF10, BOOKSHELF11, BOOKSHELF12,
		DOOR_LEFT,DOOR_RIGHT,DOOR_LEFT_L,DOOR_RIGHT_L,
		TILE_TOTAL
	};
...
public:
	...
	void Level2_mapOffset();
	void Level3_mapOffset();
};
